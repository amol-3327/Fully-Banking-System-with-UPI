...
public class u_change_l_pin extends AppCompatActivity {
    private Button update;
    private ProgressDialog progressDialog;
    private SquarePinField o_p,n_p1,n_p2;
    private String o_pin="Amol",n_pin1="M",n_pin2="S";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_u_change_l_pin);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (o_pin.equals("Amol")) {
                    Toast.makeText(u_change_l_pin.this,"Enter old PIN",Toast.LENGTH_SHORT).show();
                }else if (n_pin1.equals("M")){
                    Toast.makeText(u_change_l_pin.this,"Enter New PIN",Toast.LENGTH_SHORT).show();
                }else if (n_pin2.equals("S")){
                    Toast.makeText(u_change_l_pin.this,"Enter Confirm PIN",Toast.LENGTH_SHORT).show();
                }else if (n_pin1.equals(n_pin2)){

                    progressDialog.show();
                    StringRequest stringRequest = new StringRequest(
                            Request.Method.POST,
                            Constants.URL_CHANGE_PIN,
                                ...
                                public void onResponse(String response) {
                                    ...
                                    try {
                                        ...
                                        if (!obj.getBoolean("error")) {
                                            AlertDialog.Builder builderDel = new AlertDialog.Builder(u_change_l_pin.this);
                                            ...
                                            builderDel.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                                ...
                                                public void onClick(DialogInterface dialogInterface, int i) {
                                                    finishAffinity();
                                                    startActivity(new Intent(u_change_l_pin.this,MainActivity.class));
                        ...
                        protected Map<String, String> getParams() throws AuthFailureError {
                            ...
                            params.put("acc", SharedPrefManager.getInstance(u_change_l_pin.this).getAccNo());
                            return params;
                        }
                    };
                    RequestQueue requestQueue = Volley.newRequestQueue(u_change_l_pin.this);
                    ...
                    n_p1.setText("");
                    n_p2.setText("");
                    Toast.makeText(u_change_l_pin.this,"PIN Doesn't Match..",Toast.LENGTH_SHORT).show();
                }
            }
        });
